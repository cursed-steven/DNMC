...
(() => {
    ...
    wd_fix_switch1[1] = 3; //3番のスイッチがONの時、1番のアクターは入れ替え(外すこと)不可。
    wd_fix_switch1[2] = 4; //4番のスイッチがONの時、2番のアクターは入れ替え(外すこと)不可。
    wd_fix_switch1[5] = 5; //5番のスイッチがONの時、5番のアクターは入れ替え(外すこと)不可。
